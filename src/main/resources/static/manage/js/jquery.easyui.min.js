...
_363(_371,_372);
opts.onAdd.call(_371,_372.title,_372.center);
if(_372.selected){
_374(_371,_372.center);
}
};
...
if(item){
item.width=_712;
var rule=this.getRule(item.center);
if(rule){
...
var _844=_83d(_842,_843.center!=undefined?_843.center:_843.id);
...
view.insertRow.call(view,_85f,_860.center,_860.row);
_861.push(_860.row);
...
var row=opts.finder.getRow(_866,_867.center);
var _869=false;
_867.row=_867.row||{};
...
opts.view.updateRow.call(opts.view,_866,_867.center,_867.row);
}
};
function _86b(_86c){
...
var tr=opts.finder.getTr(_884,(_885.center!=undefined?_885.center:_885.id),_885.type);
if(!tr.length){
return;
}
